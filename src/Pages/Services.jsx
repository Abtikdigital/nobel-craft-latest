...
const Services = () => {
  ...
  const services = [
    {
      title: "Construction",
      links: "/services/construction",
      description:
        " We provide comprehensive construction services for homes, offices, and industrial projects—delivered with precision, safety, and on-time execution.",
      lists: [
        [
    ...
    },
    {
      ...
      links: "/services/steel-furniture",

      description:
        " Custom-designed, durable steel furniture solutions for homes, offices, and industrial spaces—crafted for strength and style.",
      lists: [
        [
          "Modular office workstations",
          "Customized wardrobes ",
          "Powder-coated finish options ",
          "Welded and bolted structures ",
        ],
        [
          "Heavy-duty storage racks ",
          "Hospital and lab furniture ",
          "Weather-resistant outdoor sets",
          "Eco-friendly, recyclable materials ",
        ],
        [
          "Space-saving storage solutions ",
          "Ergonomic seating and tables ",
          "Sleek, modern aesthetic designs ",
    ...
    },
    {
      ...
      links: "/services/steel-fabrication",

      description:
        " High-precision steel fabrication for industrial, commercial, and custom structural needs.",
      lists: [
        [
        ...
        [
          ...
          "Skilled craftsmanship & accuracy ",
    ...
    {
      title: "Steel Iron",
      links: "/services/steel-iron",

      description:
        " Durable, high-quality steel and iron works for construction, interiors, and industrial-grade use.",
      lists: [
        [
          "Mild steel gates and grills ",
          "Iron doors and window frames ",
    ...
    },
    {
      ...
      links: "/services/steel-iron-fabrication",

      description:
        " Expert steel and iron fabrication for durable, custom-built residential and industrial solutions.",
      lists: [
        [
          "Mild steel gates & grills ",
    ...
    },
    {
      ...
      links: "/services/electrical-goods",

      description:
        " We supply high-quality electrical products for safe, efficient, and reliable installations in residential, commercial, and industrial spaces.",
      lists: [
        [
    ...
    },
    {
      ...
      links: "/services/building-hardware",
      description:
        " Premium-quality hardware components for strong, long-lasting, and aesthetically integrated construction solutions.",
      lists: [
        [
          "Door hinges and handles ",
          "Cabinet and drawer channels ",
          "Tower bolts and latches",
          "Magnetic catches ",
        ],
        [
          "SS screws and fasteners ",
          "Window rollers and stoppers",
          "Sliding door fittings",
          "Wall plugs and anchors",
        ],
        [
          "Curtain brackets and supports",
          "Glass fittings and clamps ",
          "Heavy-duty locks and knobs ",
  ...
  return (
    <>
      ...
      <section className="md:px-24 flex flex-col gap-6">
        {services.map((section, index, arr) => (
            ...
            <div className="flex flex-col gap-6 bg-[#F7F7F7] pt-6 md:pt-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                <div className="bg-[#FF1616] py-4 flex justify-center items-center">
                  <button
                    onClick={() => {
                      navigate(arr[index]?.links);
                    }}
                    className="red-white-button border-2 border-white hover:bg-white hover:text-[#2A2A2A]"
                  >
                    LEARN MORE
                  </button>
                </div>
