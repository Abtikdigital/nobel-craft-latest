        ...
        <>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center px-6 py-12 gap-8">
                ...
                <div className="w-full lg:w-1/2 text-center lg:text-left">
                    ...
                    <p className="text-gray-700 text-lg">
                        This is a short, meaningful description that highlights your content or service.
                        It adjusts beautifully across screen sizes and ensures a great user experience.
                    </p>
                </div>
